...
uint32_t findMemoryType(uint32_t type_filter, VkMemoryPropertyFlags properties)
{
    ...
    vkGetPhysicalDeviceMemoryProperties(Base::ImGuiLayer::GetPhysicalDevice(), &mem_properties);
...
namespace Base
{
    namespace Utils
    {
        static uint32_t GetVulkanMemoryType(VkMemoryPropertyFlags properties, uint32_t type_bits)
        {
            ...
            vkGetPhysicalDeviceMemoryProperties(ImGuiLayer::GetPhysicalDevice(), &prop);
    ...
    void Image::Release()
    {
        ImGuiLayer::SubmitResourceFree([sampler             = m_Sampler,
    ...
    void Image::SetData(const void* data)
    {
        ...
        // Copy to Image
        {
            VkCommandBuffer command_buffer = ImGuiLayer::GetCommandBuffer(true);
            ...
            ImGuiLayer::FlushCommandBuffer(command_buffer);
        }
    }
